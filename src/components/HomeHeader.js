        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 ">
          <div class="flex justify-between items-center  py-6 md:justify-start md:space-x-10">
            ...
            <div class="hidden md:flex items-center justify-end space-x-8 md:flex-1 lg:w-0">
              <NavLink
                to="/login"
                class="whitespace-no-wrap text-base leading-6 font-medium text-white hover:text-gray-900 focus:outline-none focus:text-gray-900"
              >
                Log In
              </NavLink>
              <span class="inline-flex rounded-md shadow-sm">
                <NavLink
                  to="/signup"
                  class="whitespace-no-wrap inline-flex items-center justify-center px-4 py-2 border border-transparent text-base leading-6 font-medium rounded-md text-indigo-500 bg-white focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-white transition ease-in-out duration-150"
                >
                  Sign up
                </NavLink>
              </span>
