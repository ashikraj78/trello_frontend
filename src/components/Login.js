    ...
    <div className=" flex justify-between items-center">
      ...
      <div className="min-h-screen w-6/12 bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <h2 className="mt-6 text-center text-2xl leading-9 font-extrabold text-gray-600">
            Log in to trello
          </h2>
        </div>
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
              ...
              <div className="mt-6">
                ...
                <div className="mt-1 rounded-md shadow-sm">
                  <input
                    ...
                    className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                  />
                  <small className="pb-10 text-red-700">
                    {errors.password}
                  </small>
                </div>
              </div>
            ...
            <div className="mt-6">
              ...
              <NavLink
                to="/signup"
                className="ml-24 py-2 underline text-indigo-600"
              >
